...
# صفحة الـ HTML الاحترافية مدمجة لسهولة البناء على السيرفر
...
<body class="bg-slate-900 text-white min-h-screen flex flex-col justify-between">
    ...
    <main class="max-w-4xl mx-auto px-4 py-10 text-center flex-grow flex flex-col justify-center items-center">
        ...
        <p class="text-slate-400 text-sm md:text-base mb-8 max-w-xl leading-relaxed">
            ضع رابط الفيديو، ودع الذكاء الاصطناعي يتولى استخراج أفضل اللقطات، كتابة النصوص الجذابة، وإعداد المقاطع فوراً.
        </p>
    ...
    <script>
        async function startProcessing() {
            ...
            try {
                // إرسال الطلب بشكل صحيح ومباشر متوافق مع الفلاسك
...
def analyze():
    ...
    # محرك الذكاء الاصطناعي التجريبي
